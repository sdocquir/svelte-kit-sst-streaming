...
export async function convertTo({ type, response, responseStream, cookies: appCookies, }) {
    // Parse headers
    const headers = {};
...
function convertToApigV1Result(result) {
    const headers = {};
...
function convertToApigV2Result(result) {
    const headers = {};
...
function convertToApigV2StreamingResult({ statusCode, headers: rawHeaders, body, responseStream, isBase64Encoded, }) {
    const headers = {};
...
function convertToCfResult(result) {
    const headers = {};
    Object.entries(result.headers)
...
function normalizeApigV2Headers(event) {
...
function normalizeApigV2Body(event) {
...
function normalizeApigV1QueryParams(event) {
...
function normalizeApigV1Headers(event) {
